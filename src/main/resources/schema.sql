-- Schema for the SmartCare healthcare platform.
-- Executed by Spring Boot on startup when spring.sql.init.mode=always.
-- A reference copy of this exact schema also lives in sql/schema.sql.
