 ...
 * {@link CurrentUserService}, the same pattern {@code ReviewApiController}
...
public class BlogApiController {
    ...
    public BlogApiController(BlogService blogService, CurrentUserService currentUserService) {
