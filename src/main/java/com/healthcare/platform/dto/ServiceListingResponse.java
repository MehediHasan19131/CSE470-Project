...
public record ServiceListingResponse(
        Long id, String name, String email, String phone, UserRole role,
        String city, String address, String specialization,
        String serviceName, boolean emergencyAvailable,
